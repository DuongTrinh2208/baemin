        ...
        <>
            ...
            <div className="col-span-6 flex flex-row items-center gap-3" >
                ...
                <div className="flex flex-col gap-1">
                    <span className="text-base">{item.food?.description}</span>
                </div>
            </div>
            <div className="col-span-2 ml-1 flex items-center" >{item.food?.cost} </div>
            <div className="col-span-2 ml-5 flex items-center " >{item.quantity} </div>
            <div className="col-span-2 ml-5  flex items-center" >{item.food?.cost * item.quantity}</div>
        </div>
